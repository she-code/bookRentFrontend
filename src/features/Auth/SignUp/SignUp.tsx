...
export default function SignUpPage() {
  ...
  const isAdminSignup = routeLocation.pathname === "/adminSignup";
  const isOwnerSignup = routeLocation.pathname === "/ownerSignup";
  const isUserSignup = routeLocation.pathname === "/signup";
