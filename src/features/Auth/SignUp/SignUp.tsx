...
import { signUpUser, signUpOwner } from "../authActions";
...
import { useNavigate, useMatch, Link } from "raviger";
...
export default function SignUpPage() {
  ...
  const isAdminSignup = useMatch("/adminSignup");
  const isOwnerSignup = useMatch("/ownerSignup");
  const isUserSignup = useMatch("/signup");
